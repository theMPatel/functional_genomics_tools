...
def main(settings, env):
    ...
    log_message('Starting running presence/absence plasmid finder algorithm')
    ...
    log_message('Running plasmid finder algorithm...')
    ...
    # Success!
    log_message('Successfully ran plasmid finder algorithm!')
