...
def main(settings, env):
    ...
    log_message('Starting running presence/absence chtyper algorithm', 2)
    ...
    log_message('Running chtyper algorithm...', 2)
    ...
    # Success!
    log_message('Successfully ran chtyper algorithm!', 2)
